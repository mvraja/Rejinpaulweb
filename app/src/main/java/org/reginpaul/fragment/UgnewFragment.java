...
//        webView.loadUrl("https://docs.google.com/gview?embedded=true&url="+url);
        ...
        PerformNetworkRequest request = new PerformNetworkRequest("http://mindvoice.info/rpweb/v1/Api.php?apicall=getsyllabus&year=%222017%22&course=%22UG%22", null, CODE_GET_REQUEST);
        request.execute();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String url = "http://mindvoice.info/rpweb/regulations/UG2017/" + syllabus.getName() + ".pdf";
                    Log.d("UGNewURL", url);

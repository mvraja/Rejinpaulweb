...
//        webView.loadUrl("https://docs.google.com/gview?embedded=true&url="+url);
        ...
        PerformNetworkRequest request = new PerformNetworkRequest("https://rejinpaulnetwork.com/rejinpaulapp/v1/Api.php?apicall=getsyllabus&year=%222017%22&course=%22UG%22", null, CODE_GET_REQUEST);
        request.execute();

...
public class UgoldFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.d("Syllabus fragment","Entered UG2013");
...
//        webView.loadUrl("https://docs.google.com/gview?embedded=true&url="+url);
        ...
        PerformNetworkRequest request = new PerformNetworkRequest("https://rejinpaulnetwork.com/rejinpaulapp/v1/Api.php?apicall=getsyllabus&year=%222013%22&course=%22UG%22", null, CODE_GET_REQUEST);
        request.execute();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textViewName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String url = "https://rejinpaulnetwork.com/rejinpaulapp/regulations/UG2013/" + syllabus.getName() + ".pdf";
                    Log.d("UGNewURL", url);
